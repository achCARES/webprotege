...
import edu.stanford.bmir.protege.web.server.project.chg.OntologyChangeFilterer;
...
public class ProjectCache implements HasDispose {
    ...
    private ImmutableList<OntologyChange> getOntologyChanges(OWLOntology ontologyA, OWLOntology ontologyB) {
        ...
        OntologyChangeFilterer filterer = new OntologyChangeFilterer();
        for(OntologyDiff diff : ontologyDiffSet) {
            ...
            changeList.addAll(filterer.filterOutChangesDifferentOnlyByBlankNodeId(changes, ontologyB));
        }
